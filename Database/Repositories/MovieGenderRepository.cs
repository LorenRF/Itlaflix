...
namespace Itlaflix.Infrastructure.Persistence.Repositories
{
    ...
    public class MovieGenderRepository : GenericRepository<MovieGender>, IMovieGenderRepository
    {
        ...
        public MovieGenderRepository(ApplicationContext applicationContext) : base(applicationContext)
        {
